...
object PortfolioRepository {
    ...
    private val defaultPhotographs: List<Photograph> = listOf(
        ...
        Photograph(
            id = "photo_17",
            title = "The Char Island Ferry",
            bengaliTitle = "চর পারাপার",
            location = "Char Fasson, Bhola",
            year = "2025",
            category = PhotoCategory.RIVER,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Commuters boarding a long wooden country boat across tidal channels at morning tide.",
            story = "Life on the delta chars is governed by the lunar cycle. When the waters surge, travel ceases; when the tide ebbs, wooden skiffs form floating highways.",
            mood = VisualMood.RIVER_DAWN,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 35mm f/1.4", aperture = "f/4.0", shutter = "1/500s", iso = "ISO 100", focalLength = "35mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_18",
            title = "Sadarghat Porter at Twilight",
            bengaliTitle = "সদরঘাটের কুলি",
            location = "Sadarghat, Dhaka",
            year = "2026",
            category = PhotoCategory.PORTRAIT,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Veteran launch porter resting against heavy jute sack cargo between ship dockings.",
            story = "Over forty years of carrying three times his weight across slick wooden gangways has given him an indelible balance and posture.",
            mood = VisualMood.PORTRAIT_LIGHT,
            exif = CameraExif(camera = "Leica SL2", lens = "APO-Summicron-SL 50mm f/2", aperture = "f/2.0", shutter = "1/320s", iso = "ISO 800", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_19",
            title = "Monsoon Over Buriganga",
            bengaliTitle = "বুড়িগঙ্গার বাদল",
            location = "Buriganga River, Dhaka",
            year = "2025",
            category = PhotoCategory.MONSOON,
            orientation = PhotoOrientation.PANORAMIC,
            caption = "Heavy curtain of monsoon precipitation descending over dark industrial river waters.",
            story = "The rain hits like a physical wall, silencing the roar of dockyards and turning city skylines into charcoal washes.",
            mood = VisualMood.RIVER_STORM,
            exif = CameraExif(camera = "Hasselblad 907X 50C", lens = "XCD 28mm f/4 P", aperture = "f/5.6", shutter = "1/200s", iso = "ISO 200", focalLength = "28mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_20",
            title = "The Potter's Kiln Fire",
            bengaliTitle = "ভাটির গনগনে আগুন",
            location = "Dhamrai Pottery Village",
            year = "2026",
            category = PhotoCategory.STREET,
            orientation = PhotoOrientation.SQUARE,
            caption = "Rice husk embers glowing deep red inside an ancient brick kiln archway.",
            story = "Generations of potters measure the heat not with thermometers, but by the subtle shift from amber to violet inside the draft flue.",
            mood = VisualMood.OLD_DHAKA_NIGHT,
            exif = CameraExif(camera = "Leica Q3", lens = "Summilux 28mm f/1.7 ASPH", aperture = "f/1.7", shutter = "1/100s", iso = "ISO 1600", focalLength = "28mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_21",
            title = "Morning Tea on Meghna Ghat",
            bengaliTitle = "ঘাটের সকালের চা",
            location = "Chandpur Launch Ghat",
            year = "2025",
            category = PhotoCategory.STREET,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Steam rising from boiling condensed milk pots in a bamboo roadside stall.",
            story = "Before the first steamer sounds its horn, river travelers gather around tiny benches for sweetened spiced tea brewed over charcoal.",
            mood = VisualMood.RIVER_DAWN,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 35mm f/1.4", aperture = "f/2.0", shutter = "1/160s", iso = "ISO 320", focalLength = "35mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1518495973542-4542c06a5843?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1518495973542-4542c06a5843?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_22",
            title = "Old Dhaka Brass Artisan",
            bengaliTitle = "কাঁসার কারিগর",
            location = "Tantibazar, Dhaka",
            year = "2026",
            category = PhotoCategory.PORTRAIT,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Coppersmith hammering lost-wax bell bronze over a polished cast anvil.",
            story = "The rhythmic metallic chime echoes off century-old brick walls in lanes so narrow two people cannot walk abreast.",
            mood = VisualMood.PORTRAIT_LIGHT,
            exif = CameraExif(camera = "Leica M11-P", lens = "APO-Summicron-M 50mm f/2", aperture = "f/2.8", shutter = "1/250s", iso = "ISO 400", focalLength = "50mm"),
            isCuratedFeatured = false,
        ...
        Photograph(
            id = "photo_23",
            title = "Low Tide at Kuakata",
            bengaliTitle = "কুয়াকাটার ভাটা",
            location = "Patuakhali Coastline",
            year = "2024",
            category = PhotoCategory.LANDSCAPE,
            orientation = PhotoOrientation.PANORAMIC,
            caption = "Vast wet tidal plains reflecting silver twilight clouds stretching toward infinity.",
            story = "Here you can witness both the sunrise and sunset across the open bay from the exact same shoreline.",
            mood = VisualMood.COASTAL_SILENCE,
            exif = CameraExif(camera = "Hasselblad 907X 50C", lens = "XCD 28mm f/4 P", aperture = "f/8.0", shutter = "1/60s", iso = "ISO 100", focalLength = "28mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_24",
            title = "Lotus Blooms in Gajner Beel",
            bengaliTitle = "পদ্মবিলের সকাল",
            location = "Sujanagar, Pabna",
            year = "2025",
            category = PhotoCategory.LANDSCAPE,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Wild pink water lotus carpets covering morning swamp waters beneath drifting fog.",
            story = "Villagers glide through the floral beds in hollowed palm trunk dinghies to harvest lotus roots before dawn.",
            mood = VisualMood.MONSOON_MIST,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 35mm f/1.4", aperture = "f/2.8", shutter = "1/400s", iso = "ISO 160", focalLength = "35mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_25",
            title = "Rain on Corrugated Tin",
            bengaliTitle = "টিনের চালে বৃষ্টি",
            location = "Munshiganj Rural Outskirts",
            year = "2025",
            category = PhotoCategory.MONSOON,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Rainwater streaming from corrugated tin eaves into earthenware collection jars.",
            story = "The acoustic symphony of heavy monsoon drops drummed across tin roofing defines childhood memory for millions across Bengal.",
            mood = VisualMood.MONSOON_MIST,
            exif = CameraExif(camera = "Leica SL2", lens = "APO-Summicron-SL 50mm f/2", aperture = "f/2.0", shutter = "1/500s", iso = "ISO 200", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1473448912268-2022ce9509d8?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1473448912268-2022ce9509d8?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_26",
            title = "The Wooden Oar Craftsman",
            bengaliTitle = "বৈঠা বানানোর কারিগর",
            location = "Louhajang, Munshiganj",
            year = "2025",
            category = PhotoCategory.PORTRAIT,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Shaping seasoned mahogany timber oars using hand adzes and rasp planes.",
            story = "Each oar is shaped to match the user's arm span and river current depth, balancing leverage with flex.",
            mood = VisualMood.PORTRAIT_LIGHT,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 50mm f/1.4", aperture = "f/1.4", shutter = "1/800s", iso = "ISO 100", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_27",
            title = "Nocturnal Alley in Farashganj",
            bengaliTitle = "ফরাশগঞ্জের রাত",
            location = "Farashganj, Old Dhaka",
            year = "2026",
            category = PhotoCategory.STREET,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "A solitary pedestrian walking beneath 19th-century colonial brick corbels.",
            story = "Once French trading settlements, these grand river-facing mansions now stand in quiet nocturnal solitude.",
            mood = VisualMood.OLD_DHAKA_NIGHT,
            exif = CameraExif(camera = "Leica Q3", lens = "Summilux 28mm f/1.7 ASPH", aperture = "f/1.7", shutter = "1/80s", iso = "ISO 2000", focalLength = "28mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_28",
            title = "Char Silt Watermelon Harvest",
            bengaliTitle = "পলিমাটিতে তরমুজের ফলন",
            location = "Bhola Delta Chars",
            year = "2025",
            category = PhotoCategory.LANDSCAPE,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Farmers loading thousands of round melons onto anchored country cargo hulls.",
            story = "The new silt islands emerge for only six months each winter, producing miraculously sweet fruit before disappearing under floodwaters.",
            mood = VisualMood.JUTE_HARVEST,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summicron-M 35mm f/2 ASPH", aperture = "f/4.0", shutter = "1/640s", iso = "ISO 100", focalLength = "35mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_29",
            title = "Egrets in Flooded Paddy",
            bengaliTitle = "ধানক্ষেতে বকের ঝাঁক",
            location = "Faridpur Lowlands",
            year = "2025",
            category = PhotoCategory.MONSOON,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "White cattle egrets taking flight over emerald green deepwater rice stalks.",
            story = "Deepwater Aman rice grows with the rising floodwaters, its stems lengthening up to twenty feet to keep its grain heads above water.",
            mood = VisualMood.MONSOON_MIST,
            exif = CameraExif(camera = "Leica SL2", lens = "Vario-Elmarit-SL 24-70mm f/2.8", aperture = "f/3.5", shutter = "1/1000s", iso = "ISO 200", focalLength = "70mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1534088568595-a066f410bcda?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1534088568595-a066f410bcda?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_30",
            title = "The Shipyard Welder",
            bengaliTitle = "ডকইয়ার্ডের কারিগর",
            location = "Keraniganj Dockyards",
            year = "2026",
            category = PhotoCategory.PORTRAIT,
            orientation = PhotoOrientation.SQUARE,
            caption = "Blue electrical sparks casting dramatic highlights on protective steel mask visor.",
            story = "Massive steel river launches are built and repaired entirely by hand along the southern banks of the river capital.",
            mood = VisualMood.PORTRAIT_LIGHT,
            exif = CameraExif(camera = "Leica Q3", lens = "Summilux 28mm f/1.7 ASPH", aperture = "f/2.0", shutter = "1/500s", iso = "ISO 800", focalLength = "28mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_31",
            title = "Mist Over Lawachara Canopy",
            bengaliTitle = "লাউয়াছড়ার কুয়াশা",
            location = "Lawachara Forest, Sreemangal",
            year = "2025",
            category = PhotoCategory.LANDSCAPE,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Sunbeams filtering through ancient fig trees and wild bamboo thickets.",
            story = "A rainforest remnant where capped langurs swing through fog layers before midday heat dries the tropical canopy.",
            mood = VisualMood.TEA_HIGHLANDS,
            exif = CameraExif(camera = "Hasselblad 907X 50C", lens = "XCD 45mm f/4", aperture = "f/5.6", shutter = "1/125s", iso = "ISO 100", focalLength = "45mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1448375240586-882707db888b?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1448375240586-882707db888b?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_32",
            title = "Hilsa Fishermen at Night",
            bengaliTitle = "ইলিশ ধরার রাত",
            location = "Meghna Estuary, Haimchar",
            year = "2025",
            category = PhotoCategory.RIVER,
            orientation = PhotoOrientation.PANORAMIC,
            caption = "Lanterns mounted on narrow hulls drifting with the outgoing midnight current.",
            story = "Silver hilsa migrate against the freshwater current, navigating complex underwater salinity boundaries by moonlight.",
            mood = VisualMood.RIVER_STORM,
            exif = CameraExif(camera = "Leica SL2", lens = "Vario-Elmarit-SL 24-70mm f/2.8", aperture = "f/2.8", shutter = "1/30s", iso = "ISO 3200", focalLength = "35mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1514565131-fce0801e5785?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1514565131-fce0801e5785?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_33",
            title = "Kerosene Glow in Fish Market",
            bengaliTitle = "মাছের আড়তে আলো",
            location = "Swarupkathi Timber & Fish Ghat",
            year = "2025",
            category = PhotoCategory.STREET,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Brisk early morning fish auctions conducted under glowing pressurized brass lanterns.",
            story = "Hundreds of baskets of freshwater catfish, carp, and prawns change hands in under forty minutes at daybreak.",
            mood = VisualMood.OLD_DHAKA_NIGHT,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 35mm f/1.4", aperture = "f/1.4", shutter = "1/125s", iso = "ISO 800", focalLength = "35mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_34",
            title = "Dismantling Char Homestead",
            bengaliTitle = "ভাঙনের মুখে ঘরবদল",
            location = "Haimchar River Basin",
            year = "2025",
            category = PhotoCategory.RIVER,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Unbolting timber joints to move an entire homestead before the collapsing shoreline.",
            story = "Delta homes are built to be dismantled within two hours—a modular architecture dictated by river erosion.",
            mood = VisualMood.RIVER_DAWN,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summicron-M 35mm f/2 ASPH", aperture = "f/4.0", shutter = "1/500s", iso = "ISO 160", focalLength = "35mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_35",
            title = "The Rickshaw Artist's Brush",
            bengaliTitle = "রিকশা পেইন্টারের তুলি",
            location = "Bangshal, Old Dhaka",
            year = "2026",
            category = PhotoCategory.PORTRAIT,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Freehand enamel painting of movie stars and peacocks on tin backboards.",
            story = "A vibrant UNESCO-recognized intangible cultural heritage, transforming urban transport into mobile folk art galleries.",
            mood = VisualMood.PORTRAIT_LIGHT,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 50mm f/1.4", aperture = "f/1.4", shutter = "1/400s", iso = "ISO 250", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_36",
            title = "Kalbaishakhi Cloud Wall",
            bengaliTitle = "কালবৈশাখীর মেঘের দেয়াল",
            location = "Padma Delta, Shariatpur",
            year = "2026",
            category = PhotoCategory.MONSOON,
            orientation = PhotoOrientation.PANORAMIC,
            caption = "Massive anvil cloud shelf advancing across open paddy horizons with electric charge.",
            story = "Spring nor'westers strike with gale force, clearing weeks of sweltering humidity in twenty minutes of deluge.",
            mood = VisualMood.RIVER_STORM,
            exif = CameraExif(camera = "Hasselblad 907X 50C", lens = "XCD 28mm f/4 P", aperture = "f/5.6", shutter = "1/800s", iso = "ISO 100", focalLength = "28mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1534088568595-a066f410bcda?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1534088568595-a066f410bcda?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_37",
            title = "Tea Plucker in Morning Dew",
            bengaliTitle = "চা বাগানের কন্যা",
            location = "Sreemangal Tea Estates",
            year = "2025",
            category = PhotoCategory.PORTRAIT,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Plucking the tender two leaves and a bud with cane basket strapped to head.",
            story = "Woven into the rolling green hillocks of Sylhet are centuries of tea labor traditions handed down through maternal lines.",
            mood = VisualMood.TEA_HIGHLANDS,
            exif = CameraExif(camera = "Leica M11-P", lens = "APO-Summicron-M 50mm f/2", aperture = "f/2.0", shutter = "1/640s", iso = "ISO 160", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            ...
            bengaliTitle = "ভাসমান পেয়ারার হাট",
            location = "Bhimruli, Jhalakathi",
            year = "2025",
            category = PhotoCategory.RIVER,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Dozens of slender wooden boats loaded with crisp green guavas locked gunwale to gunwale.",
            story = "At the confluence of three narrow canals, the floating barter market has convened daily throughout the monsoons for over a century.",
            mood = VisualMood.RIVER_DAWN,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 35mm f/1.4", aperture = "f/2.8", shutter = "1/500s", iso = "ISO 100", focalLength = "35mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_39",
            title = "Old Dhaka Pigeon Fancier",
            bengaliTitle = "ছাদের কবুতরবাজ",
            location = "Armanitola Rooftops",
            year = "2026",
            category = PhotoCategory.STREET,
            orientation = PhotoOrientation.SQUARE,
            caption = "Flocks of white tumbler pigeons swirling against terracotta sunset sky.",
            story = "Rooftop pigeon flying is an aristocratic sport dating back to Mughal nawabs, guided purely by whistles and fabric flags.",
            mood = VisualMood.OLD_DHAKA_NIGHT,
            exif = CameraExif(camera = "Leica Q3", lens = "Summilux 28mm f/1.7 ASPH", aperture = "f/2.8", shutter = "1/1000s", iso = "ISO 200", focalLength = "28mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_40",
            title = "The Midnight Steam Whistle",
            bengaliTitle = "স্টিমারের বাঁশি",
            location = "Barishal Rocket Steamer Terminal",
            year = "2025",
            category = PhotoCategory.RIVER,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Historic paddle-wheel steamer PS Mahsud parting thick river mist under halogen lights.",
            story = "Built in British shipyards a century ago, these heritage paddle steamers remain the most romantic mode of water navigation in the world.",
            mood = VisualMood.OLD_DHAKA_NIGHT,
            exif = CameraExif(camera = "Leica SL2", lens = "APO-Summicron-SL 50mm f/2", aperture = "f/2.0", shutter = "1/40s", iso = "ISO 1600", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1514565131-fce0801e5785?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1514565131-fce0801e5785?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_41",
            title = "Submerged Jute Bundles",
            bengaliTitle = "জলে জাগ দেওয়া পাট",
            location = "Madhukhali, Faridpur",
            year = "2025",
            category = PhotoCategory.LANDSCAPE,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Green jute stalks tied with water hyacinth rotting in canal water under autumn sun.",
            story = "The retting process requires two weeks submerged in stagnant water to separate the golden fibers from the woody core.",
            mood = VisualMood.JUTE_HARVEST,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 35mm f/1.4", aperture = "f/2.8", shutter = "1/500s", iso = "ISO 100", focalLength = "35mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=1600&q=85",
        ...
        Photograph(
            id = "photo_42",
            title = "The Bamboo Shako Crossing",
            bengaliTitle = "বাঁশের সাঁকো পারাপার",
            location = "Netrokona Haor Basin",
            year = "2025",
            category = PhotoCategory.MONSOON,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Schoolchildren carefully balancing across an eighty-meter single-pole bamboo bridge.",
            story = "Ingenious, fragile, and rebuilt every year after floods recede, the shako is the delta's lifeline.",
            mood = VisualMood.MONSOON_MIST,
            exif = CameraExif(camera = "Leica SL2", lens = "Vario-Elmarit-SL 24-70mm f/2.8", aperture = "f/4.0", shutter = "1/800s", iso = "ISO 200", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_43",
            title = "Terracotta Alpona Painter",
            bengaliTitle = "আলপনা আঁকার ক্ষণ",
            location = "Shankhari Bazar, Dhaka",
            year = "2026",
            category = PhotoCategory.STREET,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Hand painting intricate white rice paste mandalas on red terracotta courtyard floor.",
            story = "The geometric floral motifs welcome the autumn season, celebrating fertility and domestic harmony.",
            mood = VisualMood.PORTRAIT_LIGHT,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 50mm f/1.4", aperture = "f/1.8", shutter = "1/320s", iso = "ISO 200", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1473448912268-2022ce9509d8?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1473448912268-2022ce9509d8?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_44",
            title = "Ganges River Dolphin Rise",
            bengaliTitle = "শুশুকের নিঃশ্বাস",
            location = "Padma-Meghna Confluence, Chandpur",
            year = "2025",
            category = PhotoCategory.RIVER,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Endangered river dolphin breaking the glassy morning surface for an instant.",
            story = "Locally known as shushuk, these blind cetaceans navigate the muddy currents purely using echolocation.",
            mood = VisualMood.RIVER_DAWN,
            exif = CameraExif(camera = "Leica SL2", lens = "Vario-Elmarit-SL 24-70mm f/2.8", aperture = "f/2.8", shutter = "1/2000s", iso = "ISO 400", focalLength = "70mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_45",
            title = "Sunset Over Jamuna Sandbar",
            bengaliTitle = "যমুনার বালুচরে সূর্যাস্ত",
            location = "Sirajganj Sandbanks",
            year = "2024",
            category = PhotoCategory.LANDSCAPE,
            orientation = PhotoOrientation.PANORAMIC,
            caption = "Crimson sun disc melting into endless sandy river dunes and ripples.",
            story = "The braided Jamuna splits into thirty simultaneous channels, creating transient islands of sand that shift year by year.",
            mood = VisualMood.MEGHNA_DUSK,
            exif = CameraExif(camera = "Hasselblad 907X 50C", lens = "XCD 28mm f/4 P", aperture = "f/5.6", shutter = "1/100s", iso = "ISO 100", focalLength = "28mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_46",
            title = "The Veteran Blacksmith",
            bengaliTitle = "কামারের হাঁপরের শব্দ",
            location = "Dhamrai Metal Works",
            year = "2026",
            category = PhotoCategory.PORTRAIT,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Elder blacksmith heating agricultural billhooks in a bellows-driven coal forge.",
            story = "He can tell the temper of steel from the exact amber shade of the glowing blade.",
            mood = VisualMood.PORTRAIT_LIGHT,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 50mm f/1.4", aperture = "f/1.4", shutter = "1/250s", iso = "ISO 320", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_47",
            title = "Rain Shadows in Betel Grove",
            bengaliTitle = "সুপারি বাগানে বৃষ্টি",
            location = "Jhalakathi Betel Gardens",
            year = "2025",
            category = PhotoCategory.MONSOON,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Slender vertical betel nut palms swaying during heavy tropical monsoon squall.",
            story = "The geometry of palm trunks creates a mesmerizing vertical grid through which sheets of rain dance.",
            mood = VisualMood.MONSOON_MIST,
            exif = CameraExif(camera = "Leica SL2", lens = "APO-Summicron-SL 50mm f/2", aperture = "f/2.8", shutter = "1/640s", iso = "ISO 200", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1518495973542-4542c06a5843?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1518495973542-4542c06a5843?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_48",
            title = "The Night Ferry Searchlight",
            bengaliTitle = "রাতের লঞ্চের সার্চলাইট",
            location = "Meghna River Channel",
            year = "2025",
            category = PhotoCategory.RIVER,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "One-million-candlepower searchlight piercing river fog to guide passengers through shoals.",
            story = "In complete darkness, the beam reveals ghostlike fishing dinghies and sandbars rushing past in seconds.",
            mood = VisualMood.OLD_DHAKA_NIGHT,
            exif = CameraExif(camera = "Leica Q3", lens = "Summilux 28mm f/1.7 ASPH", aperture = "f/1.7", shutter = "1/50s", iso = "ISO 3200", focalLength = "28mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1514565131-fce0801e5785?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1514565131-fce0801e5785?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_49",
            title = "Mosque Domes in Afternoon Light",
            bengaliTitle = "মসজিদের গম্বুজে আলো",
            location = "Sixty Dome Mosque, Bagerhat",
            year = "2024",
            category = PhotoCategory.LANDSCAPE,
            orientation = PhotoOrientation.SQUARE,
            caption = "15th-century terracotta brick arches and domes bathed in warm golden hour light.",
            story = "Founded by Khan Jahan Ali, this medieval Sultanate architecture represents the delta's sublime mastery of baked red brick.",
            mood = VisualMood.VILLAGE_SHADOW,
            exif = CameraExif(camera = "Hasselblad 907X 50C", lens = "XCD 45mm f/4", aperture = "f/5.6", shutter = "1/200s", iso = "ISO 100", focalLength = "45mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_50",
            title = "Potter Smoothing Clay Goblet",
            bengaliTitle = "মাটির পাত্রের গঠন",
            location = "Rayerbazar Potter Colony",
            year = "2026",
            category = PhotoCategory.PORTRAIT,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Finger grooves guiding the wet terracotta rim into perfect circular balance.",
            story = "The clay responds to pressure so delicate it is almost imperceptible to the observer.",
            mood = VisualMood.PORTRAIT_LIGHT,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 50mm f/1.4", aperture = "f/1.4", shutter = "1/500s", iso = "ISO 160", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_51",
            title = "Storm Clearing at Sundarbans",
            bengaliTitle = "বাদল শেষের সুন্দরবন",
            location = "Kotka Beach, Sundarbans",
            year = "2025",
            category = PhotoCategory.LANDSCAPE,
            orientation = PhotoOrientation.PANORAMIC,
            caption = "Golden sun rays piercing storm clouds over wild coastal mangrove tidal sands.",
            story = "The world's largest mangrove forest breathes with the sea, protecting millions from catastrophic ocean cyclones.",
            mood = VisualMood.COASTAL_SILENCE,
            exif = CameraExif(camera = "Hasselblad 907X 50C", lens = "XCD 28mm f/4 P", aperture = "f/8.0", shutter = "1/250s", iso = "ISO 100", focalLength = "28mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1448375240586-882707db888b?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1448375240586-882707db888b?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_52",
            title = "Children Racing Paper Boats",
            bengaliTitle = "কাগজের নাও ভাসানো",
            location = "Munshiganj Village",
            year = "2025",
            category = PhotoCategory.MONSOON,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Folded newspaper boats floating through fresh rainwater rivulets on dirt verandas.",
            story = "Simple joys of the rainy season when every puddle becomes an ocean for paper flotillas.",
            mood = VisualMood.MONSOON_MIST,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 35mm f/1.4", aperture = "f/2.0", shutter = "1/800s", iso = "ISO 200", focalLength = "35mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_53",
            title = "Tungsten Glow at Tea Stall",
            bengaliTitle = "টং দোকানের আলো",
            location = "Dhaka University Campus",
            year = "2026",
            category = PhotoCategory.STREET,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Students debating philosophy and politics around a wooden bench tea stall.",
            story = "The intellectual heartbeat of the capital beats to the rhythm of ceramic tea cups tapping saucers under yellow bulbs.",
            mood = VisualMood.OLD_DHAKA_NIGHT,
            exif = CameraExif(camera = "Leica Q3", lens = "Summilux 28mm f/1.7 ASPH", aperture = "f/1.7", shutter = "1/100s", iso = "ISO 1250", focalLength = "28mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_54",
            title = "The Jute Rope Weaver",
            bengaliTitle = "পাটের দড়ি তৈরি",
            location = "Manikganj Village",
            year = "2025",
            category = PhotoCategory.PORTRAIT,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Twisting golden fiber strands using a spinning wooden flywheel wheel.",
            story = "Natural golden jute rope secures riverboats and binds goods for commerce across South Asia.",
            mood = VisualMood.JUTE_HARVEST,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 50mm f/1.4", aperture = "f/1.4", shutter = "1/640s", iso = "ISO 160", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_55",
            title = "Sundarbans Mudflats at Dawn",
            bengaliTitle = "সুন্দরবনের শ্বাসমূল",
            location = "Sharankhola, Bagerhat",
            year = "2025",
            category = PhotoCategory.RIVER,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Pneumatophore spike roots protruding from glistening tidal clay under rose dawn mist.",
            story = "These specialized roots breathe atmospheric oxygen during low tides, keeping the delta anchored.",
            mood = VisualMood.COASTAL_SILENCE,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 35mm f/1.4", aperture = "f/4.0", shutter = "1/320s", iso = "ISO 100", focalLength = "35mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_56",
            title = "The Accordion Paper Garlands",
            bengaliTitle = "কাগজের ঝালর মেলা",
            location = "Chawkbazar Wholesale Market",
            year = "2026",
            category = PhotoCategory.STREET,
            orientation = PhotoOrientation.SQUARE,
            caption = "Vibrant rainbow tissue paper garlands hung for seasonal folk festivals.",
            story = "Crafted entirely with scissors and hand paste, transforming drab alleys into joyous festivals of color.",
            mood = VisualMood.OLD_DHAKA_NIGHT,
            exif = CameraExif(camera = "Leica Q3", lens = "Summilux 28mm f/1.7 ASPH", aperture = "f/2.8", shutter = "1/200s", iso = "ISO 400", focalLength = "28mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_57",
            title = "Monsoon Mist in Sylhet Valley",
            bengaliTitle = "সিলেটের পাহাড়ি বৃষ্টি",
            location = "Jaflong, Sylhet",
            year = "2025",
            category = PhotoCategory.MONSOON,
            orientation = PhotoOrientation.PANORAMIC,
            caption = "Clear riverbed stones and mountain runoff cascading beneath Meghalaya foothills.",
            story = "Torrential rains from the Cherrapunji plateau pour into Bangladesh's plains, feeding the haor ecosystems.",
            mood = VisualMood.TEA_HIGHLANDS,
            exif = CameraExif(camera = "Hasselblad 907X 50C", lens = "XCD 28mm f/4 P", aperture = "f/5.6", shutter = "1/400s", iso = "ISO 100", focalLength = "28mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1534088568595-a066f410bcda?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1534088568595-a066f410bcda?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_58",
            title = "Elder Storyteller on Riverbank",
            bengaliTitle = "নদীর কিসসা",
            location = "Haimchar, Chandpur",
            year = "2025",
            category = PhotoCategory.PORTRAIT,
            orientation = PhotoOrientation.PORTRAIT,
            caption = "Village elder recounting the great floods of 1988 while watching the river current.",
            story = "Oral histories of shifting river currents and lost villages reside in the memory of the elders.",
            mood = VisualMood.PORTRAIT_LIGHT,
            exif = CameraExif(camera = "Leica M11-P", lens = "Summilux-M 50mm f/1.4", aperture = "f/1.4", shutter = "1/500s", iso = "ISO 200", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_59",
            title = "The Night Crossing in Rain",
            bengaliTitle = "বৃষ্টিভেজা মেঘনা পারাপার",
            location = "Chandpur Launch Terminal",
            year = "2025",
            category = PhotoCategory.RIVER,
            orientation = PhotoOrientation.LANDSCAPE,
            caption = "Rain streaking across cabin glass as the ferry navigates open delta waters.",
            story = "The quiet hum of diesel engines and the splash of spray against the hull accompany nighttime journeys south.",
            mood = VisualMood.OLD_DHAKA_NIGHT,
            exif = CameraExif(camera = "Leica SL2", lens = "APO-Summicron-SL 50mm f/2", aperture = "f/2.0", shutter = "1/60s", iso = "ISO 2500", focalLength = "50mm"),
            isCuratedFeatured = false,
            imageUrl = "https://images.unsplash.com/photo-1514565131-fce0801e5785?auto=format&fit=crop&w=1600&q=85",
            thumbUrl = "https://images.unsplash.com/photo-1514565131-fce0801e5785?auto=format&fit=crop&w=600&q=80"
        ),
        Photograph(
            id = "photo_60",
            title = "The Eternal Flow to the Sea",
            bengaliTitle = "অনন্ত মোহনা",
            location = "Lower Bengal Delta Estuary",
            year = "2025",
            category = PhotoCategory.RIVER,
            orientation = PhotoOrientation.PANORAMIC,
            caption = "Three great rivers merging into the infinite expanse of the Bay of Bengal at twilight.",
            story = "The Padma, Meghna, and Jamuna conclude their mountain journeys here, depositing fertile earth and sustaining fifty million souls.",
            mood = VisualMood.RIVER_DAWN,
            exif = CameraExif(camera = "Hasselblad 907X 50C", lens = "XCD 28mm f/4 P", aperture = "f/8.0", shutter = "1/125s", iso = "ISO 100", focalLength = "28mm"),
            isCuratedFeatured = true,
            imageUrl = "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1600&q=85",
